      ...
      >
        ...
        <div className="text-center space-y-4">
          <h2 className={cn(
            ...
            <span className="opacity-50">&lt;</span> {t('services.title')} <span className="opacity-50">/&gt;</span>
          </h2>
          <p className={cn(
              ...
              <div className={cn(
                ...
                <div className="space-y-4">
                  ...
                  <h3 className={cn(
                    "text-xl font-bold",
                    isDark ? "text-cyan-400" : "text-indigo-600"
                  )}>{t(`services.${service.key}.title`)}</h3>
                  <p className={cn(
                  ...
                  <ul className="space-y-2">
                    {(t(`services.${service.key}.features`, { returnObjects: true }) as string[]).map((item: string) => (
                      <motion.li 
                        key={item}
                        className={cn(
